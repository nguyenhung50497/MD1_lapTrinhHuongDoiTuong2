...
function Cell(x, y) {
    ...
    this.getHtml = function(){
        ...
        let cellHtml =
            '<div id="cell-'+x+'-'+y+'" onclick="play('+x+','+y+')" class="cell" style="position: absolute;' +
            ' width: '+
...
function GameCaro(rows, cols, elementId) {
    ...
    this.draw = function () {
        let gameCaroDiv = document.getElementById(this.elementId);
...
function start() {
    gameCaro = new GameCaro(DEFAULT_ROWS, DEFAULT_COLS, "game-caro");
    gameCaro.draw();
}
let gameCaro;
start();